...
void draw() {
  ...
  camera(width/2.6, width/2.20, width/3.5, width/2, height/2, -height/3, 0, 0, -1);
  //lights();
 ambientLight(72, 101, 125);
 ambientLight(138, 71, 16);
...
void Draw_axis(float grid_size){ //<>// //<>//
  pushMatrix(); //<>//
  translate(0*grid_size, -2*grid_size, 1); //<>// //<>//
  //X //<>// //<>// //<>//
  stroke(#FF0000); //<>// //<>// //<>//
  strokeWeight(4); //<>// //<>//
...
void Draw_grid(float grid_size){ //<>// //<>//
  pushMatrix(); //<>// //<>// //<>//
  translate(-32*grid_size, -32*grid_size, 0); //<>// //<>// //<>// //<>//
  stroke(0);
  strokeWeight(1.8);
  grid(width*4, height*8, grid_size); //<>// //<>//
  popMatrix(); //<>// //<>// //<>// //<>//
} //<>// //<>//
 //<>// //<>//
...
void Draw_cylinder(float grid_size){
  ...
  pushMatrix();
  translate(grid_size*2.5, grid_size*4.5, grid_size*4.5);
  rotateX(radians(+90));
  fill(#efc6e2);
  rotateZ(PI);
  strokeWeight(1);
  drawCylinder(grid_size*0.8, grid_size*0.8, grid_size*4.5, 20);
  popMatrix();
  
  //Cilynder 2
  pushMatrix();
  translate(grid_size*8.5, grid_size*8.5, grid_size*0.8);//grid_size*3.5);
  //rotateX(radians(+90));
  fill(#efc6e2);
  rotateZ(PI);
  strokeWeight(1);
  ...
  //Cone
  pushMatrix();
  translate(grid_size*20.5, grid_size*11.5, grid_size*4);
  rotateX(radians(+90));
  //fill(#6F8EDB);
  rotateZ(PI);
  strokeWeight(1);
  drawCylinder(1, grid_size, grid_size*4, 20);
  popMatrix();
  
  //Cilynder3
  pushMatrix();
  translate(grid_size*28, grid_size*7.5, grid_size*1.7);
  rotateX(radians(+90));
  //fill(#6F8EDB);
  rotateZ(PI);
  strokeWeight(1);
